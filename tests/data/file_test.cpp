...
static_assert(data::serializers::Serializer<MyWriter, int>
              ::fixed_size == true, "");
static_assert(data::serializers::Serializer<MyWriter, std::string>
              ::fixed_size == false, "");
static_assert(data::serializers::Serializer<MyWriter, std::pair<int, short> >
              ::fixed_size == true, "");
static_assert(data::serializers::Serializer<MyWriter, std::pair<int, std::string> >
              ::fixed_size == false, "");
