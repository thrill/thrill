/*******************************************************************************
 * thrill/core/pre_bucket_reduce_flush_to_index.hpp
 *
...
#pragma once
#ifndef THRILL_CORE_PRE_BUCKET_REDUCE_FLUSH_TO_INDEX_HEADER
#define THRILL_CORE_PRE_BUCKET_REDUCE_FLUSH_TO_INDEX_HEADER
...
public:
    PreBucketReduceFlushToIndex(ReduceFunction reduce_function,
    ...
    operator()(bool consume, Table *ht) const {
        ...
        for (size_t frame_id = 0; frame_id < num_frames; frame_id++)
        {
            ...
            size_t begin_local_index = offset;

            size_t end_local_index = length;
...
#endif //THRILL_CORE_PRE_BUCKET_REDUCE_FLUSH_TO_INDEX_HEADER
